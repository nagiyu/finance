    ...
    <>
      ...
      <DirectionStack>
        <BasicSelect
          ...
          onChange={(value) =>
            onItemChange({ ...item, start: { ...item.start, hour: Number(value) } })
          }
        />
        <BasicSelect
          label="Start Minute"
          ...
          onChange={(value) =>
            onItemChange({ ...item, start: { ...item.start, minute: Number(value) } })
          }
        />
      </DirectionStack>
      <DirectionStack>
        ...
        <BasicSelect
          ...
          onChange={(value) =>
            onItemChange({ ...item, end: { ...item.end, minute: Number(value) } })
          }
        />
      </DirectionStack>
    </>
