...
var CRUDServiceBase = /** @class */ (function () {
    function CRUDServiceBase(dataAccessor, useCache) {
        if (useCache === void 0) { useCache = true; }
        this.dataAccessor = dataAccessor;
        this.useCache = useCache;
        this.cacheKey = "".concat(this.dataAccessor.getTableName(), "_").concat(this.dataAccessor.getDataType());
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2: return [4 /*yield*/, this.dataAccessor.get()];
                    case 3:
                        data = _a.sent();
                        return [2 /*return*/, data.map(this.recordToData)];
                }
            });
        });
    };
    CRUDServiceBase.prototype.getById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var cachedData, item, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.useCache) return [3 /*break*/, 2];
                    ...
                    case 1:
                        cachedData = _a.sent();
                        item = cachedData.find(function (i) { return i.id === id; });
                        return [2 /*return*/, item || null];
                    case 2: return [4 /*yield*/, this.dataAccessor.getById(id)];
                    case 3:
                        data = _a.sent();
                        if (!data) {
                            return [2 /*return*/, null];
                        }
                        return [2 /*return*/, this.recordToData(data)];
                }
            });
        });
    };
    CRUDServiceBase.prototype.create = function (creates) {
        return __awaiter(this, void 0, void 0, function () {
            var data, item, cachedData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dataAccessor.create(this.dataToRecord(creates))];
                    case 1:
                        data = _a.sent();
                        item = this.recordToData(data);
                        if (!this.useCache) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.getCache()];
                    case 2:
                        cachedData = _a.sent();
    ...
    CRUDServiceBase.prototype.update = function (id, updates) {
        return __awaiter(this, void 0, void 0, function () {
            var data, item, cachedData, index;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dataAccessor.update(id, this.dataToRecord(updates))];
                    case 1:
                        data = _a.sent();
                        if (!data) {
                            ErrorUtil_1.default.throwError("Failed to update item with id: ".concat(id));
                        }
                        item = this.recordToData(data);
                        if (!this.useCache) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.getCache()];
    ...
    CRUDServiceBase.prototype.getCache = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        cachedData = CacheUtil_1.default.get(this.cacheKey);
                        if (cachedData) {
