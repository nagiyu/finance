...
export const GyakusanzonConditionInfo: ConditionInfo = {
  name: '逆三尊',
  description:
    '逆三尊（Inverse Head and Shoulders）は、下落トレンドの終盤に現れやすい強気の反転パターンです。3つの谷（底）を形成し、中央の谷（頭）が最も深く、両側の谷（肩）は類似の深さで頭より浅くなります。谷と谷の間の高値（山）を結んだネックラインを明確に上抜けることで上昇トレンド入りのシグナルとされます。厳格な検証により、山の高さ（2%以上の反発）、肩の対称性、ネックライン突破の確認を行います。',
  isBuyCondition: true,
