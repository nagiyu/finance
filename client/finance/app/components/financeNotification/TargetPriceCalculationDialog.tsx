...
import BasicRadioGroup, {
  BasicRadioGroupOption,
} from '@client-common/components/inputs/RadioGroups/BasicRadioGroup';
    ...
    (async () => {
      try {
        ...
        const matchingTicker = myTickers.find(
          (mt) => mt.userId === user.id && mt.exchangeId === exchangeId && mt.tickerId === tickerId
        );
