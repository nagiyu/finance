...
interface AdminManagementWithCacheProps<ItemType extends DataTypeBase, StateType extends Record<string, unknown> = Record<string, unknown>> {
...
export default function AdminManagementWithCache<ItemType extends DataTypeBase, StateType extends Record<string, unknown> = Record<string, unknown>>({
    columns,
    loading = false,
    fetchData,
    itemName,
    ...
    onRefresh,
    children
}: AdminManagementWithCacheProps<ItemType, StateType>) {
